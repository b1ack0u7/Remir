...
struct PomodorVW: View {
    ...
    @State private var weekDayNames: [String] = ClassesContainer().daysWeekName(lan: "es")
    ...
    var body: some View {
        ...
        .sheet(isPresented: $showModalAdd, onDismiss: {
            ...
            HomeVWAddActivity(showModalAddActivity: $showModalAdd, weekDays: weekDayNames, lan: "es", currentDayE: currentInfo[4]).environment(\.managedObjectContext, viewContext)
        })
        .onAppear {
            loadInterface()
            sortingDisplay()
    ...
    private func loadInterface() {
        ...
        if("es" == "es" && currentInfo[3] == "Miércoles") {
